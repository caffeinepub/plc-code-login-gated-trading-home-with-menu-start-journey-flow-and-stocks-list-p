        ...
        >
          ...
          {phase === "app" && showMaintenanceScreen && (
            ...
            >
              ...
              >
                ...
                maintenance. We will be back shortly. Thank you for your
                patience.
              </p>
              <div
                style={{
          ...
          {phase === "app" && !showFrozenScreen && !showMaintenanceScreen && (
            <div className="relative">
              ...
              {page === "add-funds" && (
                <AddFunds onBack={() => setPage("home")} />
              )}
              {page === "verifying" && (
                <Verifying onBack={() => setPage("home")} />
              )}
              {page === "withdrawal" && (
